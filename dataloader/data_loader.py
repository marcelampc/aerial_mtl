...
def CreateDataLoader(opt, Dataset=DatasetFromFolder):
    ...
    if opt.validate:
        ...
        set_valloader = Dataset(opt, opt.dataroot, phase='val', data_split=opt.val_split, data_augmentation=["F", "F", "F", "F", "F"], crop=False, resize=resize, data_transform=data_transform, imageSize=opt.imageSize,
    ...
    set_dataloader = Dataset(opt, opt.dataroot, phase=phase, data_split=split, data_augmentation=opt.data_augmentation, crop=crop, resize=resize, data_transform=data_transform,
